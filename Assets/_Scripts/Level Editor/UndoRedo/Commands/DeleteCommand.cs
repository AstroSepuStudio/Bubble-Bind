...
public class DeleteCommand : ICommand
{
    ...
    public DeleteCommand(LevelEditorManager levelEditorManager, EditorElement element)
    {
    ...
    public void Undo()
    {
        ...
        _instantiatedElement.SetUpElement(_levelEditorManager);
    }
}

public class BulkDeleteCommand : ICommand
{
    LevelEditorManager _levelEditorManager;
    ...
    public BulkDeleteCommand(LevelEditorManager levelEditorManager, List<EditorElement> elements)
    {
        _levelEditorManager = levelEditorManager;
        _instantiatedElements = new(elements);
